    ...
    <div className="w-[107px] h-[1024px] bg-green-500 flex-col justify-start items-start inline-flex z-30">
      <div className="w-[107px] grow shrink basis-0 px-8 py-[50px] flex-col justify-start items-start gap-[50px] flex">
        ...
        <div className="flex-col justify-center items-center gap-8 flex ">
          ...
          <button onClick={(e:any)=> handleEventCreation(e)} className="hover:bg-white hover:bg-opacity-10 py-2 px-2 hover:rounded-xl active:bg-white active:bg-opacity-10 active:rounded-xl">
      ...
      {showModal && (
        <Modal onClose={() => setShowModal(false)} buttons={buttons}>
          <p className="text-center">Only Users with completed profiles can create events</p>
        </Modal>
      )}
       {showModal2 && (
        <Modal onClose={() => setShowModal2(false)} buttons={buttons2}>
          <p className="text-center">Please update your avatar before you can create events</p>
        </Modal>
      )}
    </div>
  );
